          ...
          <div className="grid-cols-[70%_30%] gap-12">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">See our refrigeration systems operating under real-world conditions</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Get personalized advice from our refrigeration specialists</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Design the perfect refrigeration system for your business</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Learn proper operation and maintenance techniques</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-primary/10 to-gunmetal/10 rounded-2xl p-6">
                <h3 className="font-bold text-lg mb-3">Why Visit Us?</h3>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• Experience products before making investment decisions</li>
                  <li>• Compare different models and configurations side-by-side</li>
                  <li>• Meet with our technical experts and ask questions</li>
                  <li>• See energy efficiency and performance in real-time</li>
