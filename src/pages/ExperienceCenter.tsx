      ...
      <section className="py-16">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="relative max-w-4xl mx-auto">
            <div className="relative h-[200px] md:h-[600px] lg:h-[700px] rounded-2xl overflow-hidden bg-gradient-to-r from-primary/10 to-gunmetal/10">
              <img
              ...
              <button
                onClick={prevSlide}
                className="absolute left-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/30 transition-all duration-200"
              >
              ...
              <button
                onClick={nextSlide}
                className="absolute right-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/30 transition-all duration-200"
              >
