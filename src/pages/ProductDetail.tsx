  ...
  const products = [
    ...
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'Rapid blast freezing preserves food quality',
          'Digital monitoring ensures temperature control',
      ...
      materials: {
        ...
        materialSpecs: [
          '304 stainless steel interior walls',
          'Polyurethane foam insulation',
          'Galvanized steel exterior frame',
          'Heavy-duty floor construction',
      ...
      performance: {
        ...
        performanceMetrics: [
          'Blast freeze time: 90 minutes to -18°F',
          'Temperature uniformity: ±2°F',
          'Energy efficiency: 20% above standard',
          'Defrost cycle: Automatic hot gas',
          'Capacity: Up to 1,000 lbs per cycle'
        ]
      }
    },
    {
      ...
      design: {
        ...
        designFeatures: [
          ...
          'Bowl guard safety system',
          'Variable speed transmission',
          'Attachment hub for accessories',
      ...
      materials: {
        ...
        materialSpecs: [
          ...
          'Cast iron transmission housing',
      ...
      performance: {
        ...
        performanceMetrics: [
          'Mixing speeds: 65, 125, 190 RPM',
          'Dough capacity: 50 lbs',
          'Whip capacity: 38 egg whites',
          'Motor power: 3 HP',
    ...
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'Steam and convection combination cooking',
      ...
      design: {
        ...
        designFeatures: [
          ...
          'Multi-point temperature probes',
      ...
      materials: {
        ...
        materialSpecs: [
          ...
          'Heat-resistant door glass',
          'Food-grade water system',
    ...
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'Dual basket system for efficiency',
          'Built-in oil filtration extends oil life',
      ...
      design: {
        ...
        designFeatures: [
          'Twin fry baskets with lift mechanism',
          'Digital temperature display',
          'Oil level indicator',
      ...
      materials: {
        ...
        materialSpecs: [
          ...
          'Cast iron burner system',
          'Stainless steel exterior',
          'Heat-resistant basket material',
          'Professional-grade valves'
        ]
      },
      performance: {
        ...
        performanceMetrics: [
          ...
          'Oil capacity: 50 lbs per vat',
          'Production rate: 75 lbs/hour',
    ...
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'High-temperature sanitizing kills bacteria',
          'Fast wash cycles increase efficiency',
      ...
      design: {
        ...
        designFeatures: [
          'Single tank wash system',
          'Built-in booster heater',
          'Chemical pump system',
          'Low water consumption design',
          'Easy-load rack system'
        ]
      },
      materials: {
      ...
      performance: {
        ...
        performanceMetrics: [
          'Wash cycle: 90 seconds',
          'Water usage: 0.7 gallons per rack',
          'Final rinse temp: 180°F',
          'Rack capacity: 30 per hour',
    ...
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'Large 14-cup capacity bowl',
          'Multiple cutting disc options',
      ...
      materials: {
        ...
        materialSpecs: [
          ...
          'Polycarbonate processing bowl',
          'Cast aluminum motor housing',
          'Stainless steel disc blades',
      ...
      performance: {
        ...
        performanceMetrics: [
          'Motor power: 3 HP',
          'Processing capacity: 14 cups',
          'Speed range: 300-3,600 RPM',
    ...
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'Adjustable heat zones for control',
          'Fast heating for quick service',
      ...
      performance: {
        ...
        performanceMetrics: [
          ...
          'Cooking surface: 36" x 15"',
          'BTU output: 28,000',
          'Temperature range: 250°F - 1,000°F',
    ...
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          ...
          'Antimicrobial protection system',
          'Reliable cube ice production'
        ]
      },
      design: {
      ...
      materials: {
        ...
        materialSpecs: [
          ...
          'Antimicrobial plastic components',
      ...
      performance: {
        ...
        performanceMetrics: [
          'Ice production: 500 lbs/24 hours',
          'Storage capacity: 200 lbs',
          'Energy consumption: 8.5 kWh/100 lbs',
          'Water usage: 21 gallons/100 lbs',
    ...
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'Large 40-gallon cooking capacity',
          'Tilting mechanism for easy serving',
      ...
      materials: {
        ...
        materialSpecs: [
          ...
          'Cast iron burner assembly',
          'Stainless steel exterior',
          'Heavy-duty tilting mechanism',
    ...
    },
    {
      ...
      materials: {
        ...
        materialSpecs: [
          '1-inch thick steel cooking plate',
          'Stainless steel exterior',
          'Cast iron burner system',
          'Stainless steel grease trough',
      ...
      performance: {
        ...
        performanceMetrics: [
          'Cooking surface: 48" x 24"',
          'BTU output: 105,000',
          'Temperature range: 200°F - 550°F',
          'Recovery time: 5 minutes',
          'Heat zones: 4 independent'
        ]
      }
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'Chamber sealing technology',
          'Digital control system',
          'Multiple seal bar configuration',
          'Oil pump system for consistency',
      ...
      design: {
        ...
        designFeatures: [
          ...
          'Programmable cycle controls',
          'Multiple sealing positions',
          'Easy-load chamber design'
        ]
      },
      materials: {
      ...
      performance: {
        ...
        performanceMetrics: [
          'Vacuum level: 99.9%',
          'Chamber size: 16" x 20" x 6"',
          'Seal bar length: 16"',
          'Cycle time: 20-40 seconds',
          'Pump capacity: 21 CFM'
        ]
      }
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          ...
          'Heavily insulated cooking chamber',
          'Professional BBQ results'
        ]
      },
      design: {
      ...
      performance: {
        ...
        performanceMetrics: [
          'Cooking capacity: 12 full racks',
          'Temperature range: 150°F - 300°F',
          'Temperature accuracy: ±5°F',
          'Smoke generation: Automatic',
    ...
    },
    {
      ...
      materials: {
        ...
        materialSpecs: [
          'Stainless steel cooking tank',
          'Stainless steel baskets',
          'Heavy-duty lift mechanism',
          'Stainless steel exterior',
      ...
      performance: {
        ...
        performanceMetrics: [
          'Basket capacity: 6 individual',
          'Water capacity: 15 gallons',
          'BTU output: 45,000',
          'Recovery time: 3 minutes',
          'Production rate: 30 portions/hour'
        ]
      }
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          ...
          'Reversible operation capability',
          'Food-grade roller construction',
      ...
      performance: {
        ...
        performanceMetrics: [
          'Roller width: 20 inches',
          'Thickness range: 1-20mm',
          'Belt speed: 15 ft/minute',
          'Motor power: 2 HP',
          'Production capacity: 200 lbs/hour'
        ]
      }
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'Rapid blast chilling and freezing',
          'Core probe temperature monitoring',
          'Programmable cycle controls',
          'HACCP compliance features',
          'Food safety optimization'
        ]
      },
      design: {
      ...
      materials: {
        ...
        materialSpecs: [
          ...
          'Professional refrigeration system'
        ]
      },
      performance: {
        description: 'Delivers rapid cooling performance with precise temperature control and monitoring.',
        performanceMetrics: [
          'Chill time: 90 minutes (+160°F to +37°F)',
          'Freeze time: 240 minutes (+160°F to -0°F)',
          'Capacity: 15 full-size pans',
          'Temperature range: +160°F to -40°F',
          'Data logging: 100 cycles'
        ]
      }
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'Dual boiler system for consistency',
          'Professional steam wands',
          'Programmable shot controls',
          'Built-in cup warming system',
      ...
      design: {
        ...
        designFeatures: [
          'Two group head configuration',
          'Digital shot programming',
          'Professional steam wands',
          'Cup warming surface',
      ...
      performance: {
        ...
        performanceMetrics: [
          ...
          'Steam pressure: 1.5 bars',
          'Shot volume: Programmable',
    ...
    },
    {
      ...
      performance: {
        ...
        performanceMetrics: [
          'Power output: 3.5 kW per zone',
          'Temperature range: 140°F - 460°F',
          'Efficiency rating: 90%',
          'Response time: Instant',
          'Energy consumption: 25% less than gas'
        ]
      }
    },
    {
      ...
      performance: {
        ...
        performanceMetrics: [
          ...
          'Motor power: 1/2 HP',
          'Cutting capacity: 8" x 6"',
          'Slicing speed: 40 slices/minute'
        ]
      }
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'Multiple spit capacity',
          'Self-basting cooking action',
          'Glass viewing doors',
    ...
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'Precise humidity control system',
          'Multiple shelf configurations',
          'Digital temperature display',
          'Heavily insulated construction',
    ...
    },
    {
      ...
      overview: {
        ...
        keyBenefits: [
          'High-pressure cooking capability',
          'Multiple cooking compartments',
      ...
      performance: {
        ...
        performanceMetrics: [
          ...
          'Cooking time: 50% faster',
          'Compartments: 6 individual',
          'Steam generation: 40 lbs/hour',
          'Safety rating: ASME certified'
        ]
      }
    },
    {
      ...
      performance: {
        ...
        performanceMetrics: [
          'Temperature range: 80°F - 120°F',
          'Humidity range: 80-95%',
          'Capacity: 18 full-size pans',
          'Temperature accuracy: ±1°F',
          'Proofing time: 30-180 minutes'
        ]
      }
    },
    {
      ...
      performance: {
        ...
        performanceMetrics: [
          ...
          'Temperature range: Ambient to 180°F',
